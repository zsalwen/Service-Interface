...
<table style="border:solid 1px; font-size: 12px;" border=1 width="700px" align="center">
    ...
    <tr>
    	<td colspan="5" align="center"><div style="width:650px; text-align:justify;"><div style="border:ridge 3px; font-size: 16px; width: 400px; align:justify;"><strong style="text-decoration:underline;">ALL SERVICE MUST TAKE INTO ACCOUNT:</strong><br>'Two good faith attempts on separate days' - MD Rule 14-209(b)</div>
