...
<br><iframe width="500px" height="60px" src="http://service.mdwestserve.com/penalize.php?packet=<?=$packet?>&svc=OTD&defendant=<?=$defendant?>" frameborder='0' scrolling='no'></iframe>
<? } ?>
