...
if (($defs == $defCount && $ddr[caseVerify] != '') || $_POST[overRide] > 0){
	if ($_POST[overRide] == 2){
		...
		$q10="UPDATE evictionPackets SET process_status='READY TO MAIL', affidavit_status='SERVICE CONFIRMED' WHERE eviction_id = '$packet'";
		$r10=@mysql_query($q10) or die ("Query: $q10<br>".mysql_error());
		psActivity("mailPrep");
		ev_timeline($packet,$_COOKIE[psdata][name]." Ready to Mail");		?>
