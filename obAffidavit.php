...
function makeAffidavit($p,$defendant,$level,$user_id){
	...
	if ($type == "non"){
		...
		if ($attempts != ''){
			...
			$history2 = "<div style='font-weight:300'><u>Include the date of the posting and a description of the location of the posting on the property:<br>I, [SERVERNAME], posted the Papers to the property in the following manner:</u></div>".$posting;
		if ($mailing == ''){
