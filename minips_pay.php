...
<a href="http://mdwestserve.com/ps/ps_write_invoice.php?id=<?=$data[packet_id];?>" target="_Blank">PS Write Invoice</a>
<fieldset>
...
<FIELDSET>
<LEGEND class="a" ACCESSKEY=C><a href="http://mdwestserve.com/ps/dispatcher.php?aptsut=&address=<?=str_replace('#','',$data[address1a])?>&city=<?=$data[city1a]?>&state=<?=$data[state1a]?>&miles=5" target="_Blank">Possible Place of Abode</a> <input type="checkbox"><br><?=id2name($data[server_ida]);?></LEGEND>
<table>
<tr>
...
<FIELDSET>
<LEGEND class="a" ACCESSKEY=C><a href="http://mdwestserve.com/ps/dispatcher.php?aptsut=&address=<?=$data[address1b]?>&city=<?=$data[city1b]?>&state=<?=$data[state1b]?>&miles=5" target="_Blank">Possible Place of Abode</a> <input type="checkbox"><br><?=id2name($data[server_idb]);?></LEGEND>
<table>
<tr>
...
<FIELDSET>
<LEGEND class="a" ACCESSKEY=C><a href="http://mdwestserve.com/ps/dispatcher.php?aptsut=&address=<?=$data[address1c]?>&city=<?=$data[city1c]?>&state=<?=$data[state1c]?>&miles=5" target="_Blank">Possible Place of Abode</a> <input type="checkbox"><br><?=id2name($data[server_idc]);?></LEGEND>
<table>
<tr>
...
<FIELDSET>
<LEGEND class="a" ACCESSKEY=C><a href="http://mdwestserve.com/ps/dispatcher.php?aptsut=&address=<?=$data[address1d]?>&city=<?=$data[city1d]?>&state=<?=$data[state1d]?>&miles=5" target="_Blank">Possible Place of Abode</a> <input type="checkbox"><br><?=id2name($data[server_idd]);?></LEGEND>
<table>
<tr>
...
<FIELDSET>
<LEGEND class="a" ACCESSKEY=C><a href="http://mdwestserve.com/ps/dispatcher.php?aptsut=&address=<?=$data[address1e]?>&city=<?=$data[city1e]?>&state=<?=$data[state1e]?>&miles=5" target="_Blank">Possible Place of Abode</a> <input type="checkbox"><br><?=id2name($data[server_ide]);?></LEGEND>
<table>
<tr>
...
<tr><td></td><td>
<FIELDSET>
<LEGEND class="a" ACCESSKEY=C><a href="http://mdwestserve.com/ps/dispatcher.php?aptsut=&address=<?=$data[pobox]?>&city=<?=$data[pocity]?>&state=<?=$data[postate]?>&miles=5" target="_Blank">Mail Only 1</a> <input type="checkbox"></LEGEND>
<table>
<tr>
...
<FIELDSET>
<LEGEND class="a" ACCESSKEY=C><a href="http://mdwestserve.com/ps/dispatcher.php?aptsut=&address=<?=$data[pobox2]?>&city=<?=$data[pocity2]?>&state=<?=$data[pozip2]?>&miles=5" target="_Blank">Mail Only 2</a> <input type="checkbox"></LEGEND>
<table>
<tr>
