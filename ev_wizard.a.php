...
if ($_COOKIE[psdata][level] == "Operations"){
	$q1="select eviction_id, address1, name1, name2, name3, name4, name5, name6 from evictionPackets ORDER BY eviction_id DESC";
}else{
	$q1="select eviction_id, address1, name1, name2, name3, name4, name5, name6 from evictionPackets where ((server_id = '$server') or (server_ida = '$server') or (server_idb = '$server') or (server_idc = '$server') or (server_idd = '$server') or (server_ide = '$server')) ORDER BY eviction_id DESC";
}
