...
$r1=@mysql_query("select eviction_id, name1, name2, name3, name4, name5, name6 from evictionPackets ORDER BY eviction_id DESC");
}else{
$r1=@mysql_query("select eviction_id, name1, name2, name3, name4, name5, name6 from evictionPackets where ((server_id = '$server') or (server_ida = '$server') or (server_idb = '$server') or (server_idc = '$server') or (server_idd = '$server') or (server_ide = '$server')) ORDER BY eviction_id DESC");
}
