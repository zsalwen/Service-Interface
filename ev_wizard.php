...
DEFENDANT: <a href="http://service.mdwestserve.com/ev_wizard.php?jump=<?=$packet?>-1<? if ($mailDate){ echo "&mailDate=".$mailDate;} ?>"><?if ($defendant == '1'){ echo "<b>1</b>";}else{ echo "1";}?></a>
<? if ($ddr[name2]){?> <a href="http://service.mdwestserve.com/ev_wizard.php?jump=<?=$packet?>-2<? if ($mailDate){ echo "&mailDate=".$mailDate;} ?>"><?if ($defendant == '2'){ echo "<b>2</b>";}else{ echo "2";}?></a><? } ?>
<? if ($ddr[name3]){?> <a href="http://service.mdwestserve.com/ev_wizard.php?jump=<?=$packet?>-3<? if ($mailDate){ echo "&mailDate=".$mailDate;} ?>"><?if ($defendant == '3'){ echo "<b>3</b>";}else{ echo "3";}?></a><? } ?>
<? if ($ddr[name4]){?> <a href="http://service.mdwestserve.com/ev_wizard.php?jump=<?=$packet?>-4<? if ($mailDate){ echo "&mailDate=".$mailDate;} ?>"><?if ($defendant == '4'){ echo "<b>4</b>";}else{ echo "4";}?></a><? } ?>
<? if ($ddr[name5]){?> <a href="http://service.mdwestserve.com/ev_wizard.php?jump=<?=$packet?>-5<? if ($mailDate){ echo "&mailDate=".$mailDate;} ?>"><?if ($defendant == '5'){ echo "<b>5</b>";}else{ echo "5";}?></a><? } ?>
<? if ($ddr[name6]){?> <a href="http://service.mdwestserve.com/ev_wizard.php?jump=<?=$packet?>-6<? if ($mailDate){ echo "&mailDate=".$mailDate;} ?>"><?if ($defendant == '6'){ echo "<b>6</b>";}else{ echo "6";}?></a><? } ?>
