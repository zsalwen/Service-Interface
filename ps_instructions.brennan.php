...
<table align="center" width="700px" style="font-variant:small-caps;" border="0">
	<tr>
    	<td valign="bottom" align="center" style="font-size:18px; font-variant:small-caps;" height="50px;">MDWestServe, Inc.<br>410-828-4568<br>Service Type 'C' For Packet <?=$_GET[packet]?></td>
    </tr>
	<tr>
...
<table style="border:solid 1px; font-size: 12px;" width="700px" align="center">
	<tr>
    	<td colspan="5" align="center"><b>Service Type 'C':</b></td>
    </tr>
    <tr>
    	<td colspan="5" align="center"><ul><li><b>You cannot make two attempts at the same property on the same day.</b></li>
        <li><b>posting</b> must be done <b>after</b> <u>all attempts</u> have been completed.</li>
        <li><b>posting</b> must be done on a separate day from any other attempts.</li>
        ...
        <li>Photographs are required for <b>posting</b>s, advised for attempts.</li>
