<? if (!$dname){ echo "<h1>NO DEFENDANT</h1>";} 
	...
	?>
<? if ($ddr[affidavit_status] != "IN PROGRESS" && $ddr[affidavit_status] != "NEED CORRECTION"){?>
<div class="nav3"><input onClick="window.open( 'evictionAff.php?id=<?=$packet?>&def=<?=$defendant?>', 'Affidavit', 'status = 1, height = 900, width = 1000, scrollbars = 1, resizable = 1' )" type="radio" name="service_type" value="PRINT" /> PRINT AFFIDAVIT</div>
