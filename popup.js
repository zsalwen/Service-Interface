...
displayfiles: ['notice.php'],

//2) display freqency: ["frequency_type", "frequency_value"]
displayfrequency: ["chance", "10"],

//3) HTML for the header bar portion of the interstitial box
defineheader: '<div class="headerbar"><a href="#" onClick="javascript:interstitialBox.closeit(); return false"><img src="gfx/closeit.gif" style="border: 0" title="Close Box"/></a></div>',
