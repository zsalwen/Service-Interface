...
<table style="border:solid 1px; font-size: 12px;" border=1 width="600px" align="center">
    ...
    <tr>
    	<td colspan="5" align="center"><div style="width:400px; text-align:left;"><div style="border:ridge 3px; font-size: 16px;"><strong style="text-decoration:underline;">ALL SERVICE MUST TAKE INTO ACCOUNT:</strong><br>'Two good faith attempts on separate days' - MD Rule 14-209(b)</div>
        ...
        <li>Photographs are required for <b>posting</b>s as well as for <b>attempt</b>s.</li></div></td>
    </tr>
    <tr>
	...
	<tr>
    	<td>3</td>
      	<td>One attempt at third address</td>
        <td>One attempt at second address</td>
        <td><b>posting</b> at Deed of Trust address</td>
        <td></td>
    </tr>
	<tr>
    	<td>4+</td>
      	<td>One attempt at fourth address</td>
        <td>One attempt at third address</td>
        <td>One attempt at second address</td>
        <td><b>posting</b> at Deed of Trust address</td>
    </tr>
