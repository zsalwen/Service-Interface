...
if ($data2 == ''){
	...
	if ($data2[useNotes] == 'checked'){
		...
		<tr>
			<td align="center" style="width:700px;font-size:13px;"><div style="width:700px; text-align:left; border: 1px solid black;"><fieldset><legend>SERVICE REQUIREMENTS</legend><div style="border:3px ridge black; font-size: 16px; width=650px;"><strong style="text-decoration:underline;">ALL SERVICE MUST TAKE INTO ACCOUNT:</strong><br>'Two good faith attempts on separate days' - MD Rule 14-209(b)</div>
