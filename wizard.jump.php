...
<? if ($_GET[photojump]){?>
<form method="post" name="form1" id="form1" action="wizard.php" target="_self"><input type="hidden" name="i" value="photo.upload.1" /><input type="hidden" name="parts" value="<?=$_GET[jump]?>" /><input type="hidden" name="opServer" value="<?=$_GET[server]?>" />
<? }else{ ?>
