...
$dir = "/opt/lampp/htdocs/ps/photographs";
if ($handle = opendir($dir)) {
    while (false !== ($file = readdir($handle))) {
        if ($file != "." && $file != "..") {
            // start move
//			echo "Found: <strong>$file</strong><br>";
			$source .=	"\"photographs/$file\",\"http://www.dynamicdrive.com\",
			";
        }
    }
    closedir($handle);
}
$source .= "\"photo4.jpg\",\"http://www.codingforums.com\" // NOTE No comma after last line
";
...
<center>
<div id="Carousel" style="position:relative; width:900px;">
   <img src="placeholder.gif" width="900" height="600" border="0">
</div>
</center>
