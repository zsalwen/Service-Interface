...
function entryLoop($packet,$def){
	...
	$data .= "<tr><td><b>Attempt 1 at $d[address1]</b> Month/Day/Year: <select>".mkmonth('')."</select> <select>".mkday('')."</select> <select>".mkyear('')."</select> Hour/Minute/AM-PM: <select>".mkmonth('')."</select> <select>".mkminute('')."</select>
 <select ><option value='AM'>AM</option><option value='PM'>PM</option></select> Effort to Rouse Defendant: <input size='50'></td></tr>";
	$data .= "<tr><td><b>Attempt 2 at $d[address1]</b> Month/Day/Year: <select>".mkmonth('')."</select> <select>".mkday('')."</select> <select>".mkyear('')."</select> Hour/Minute/AM-PM: <select>".mkmonth('')."</select> <select>".mkminute('')."</select>
 <select ><option value='AM'>AM</option><option value='PM'>PM</option></select> Effort to Rouse Defendant: <input size='50'></td></tr>";
	if ($d[address1a]){
		$data .= "<tr><td><b>Attempt 1 at $d[address1a]</b> Month/Day/Year: <select>".mkmonth('')."</select> <select>".mkday('')."</select> <select>".mkyear('')."</select> Hour/Minute/AM-PM: <select>".mkmonth('')."</select> <select>".mkminute('')."</select>
 <select ><option value='AM'>AM</option><option value='PM'>PM</option></select> Effort to Rouse Defendant: <input size='50'></td></tr>";
		$data .= "<tr><td><b>Attempt 2 at $d[address1a]</b> Month/Day/Year: <select>".mkmonth('')."</select> <select>".mkday('')."</select> <select>".mkyear('')."</select> Hour/Minute/AM-PM: <select>".mkmonth('')."</select> <select>".mkminute('')."</select>
 <select ><option value='AM'>AM</option><option value='PM'>PM</option></select> Effort to Rouse Defendant: <input size='50'></td></tr>";
	}
	if ($d[address1b]){
		$data .= "<tr><td><b>Attempt 1 at $d[address1b]</b> Month/Day/Year: <select>".mkmonth('')."</select> <select>".mkday('')."</select> <select>".mkyear('')."</select> Hour/Minute/AM-PM: <select>".mkmonth('')."</select> <select>".mkminute('')."</select>
 <select ><option value='AM'>AM</option><option value='PM'>PM</option></select> Effort to Rouse Defendant: <input size='50'></td></tr>";
		$data .= "<tr><td><b>Attempt 2 at $d[address1b]</b> Month/Day/Year: <select>".mkmonth('')."</select> <select>".mkday('')."</select> <select>".mkyear('')."</select> Hour/Minute/AM-PM: <select>".mkmonth('')."</select> <select>".mkminute('')."</select>
 <select ><option value='AM'>AM</option><option value='PM'>PM</option></select> Effort to Rouse Defendant: <input size='50'></td></tr>";
	}
	if ($d[address1c]){
		$data .= "<tr><td><b>Attempt 1 at $d[address1c]</b> Month/Day/Year: <select>".mkmonth('')."</select> <select>".mkday('')."</select> <select>".mkyear('')."</select> Hour/Minute/AM-PM: <select>".mkmonth('')."</select> <select>".mkminute('')."</select>
 <select ><option value='AM'>AM</option><option value='PM'>PM</option></select> Effort to Rouse Defendant: <input size='50'></td></tr>";
		$data .= "<tr><td><b>Attempt 2 at $d[address1c]</b> Month/Day/Year: <select>".mkmonth('')."</select> <select>".mkday('')."</select> <select>".mkyear('')."</select> Hour/Minute/AM-PM: <select>".mkmonth('')."</select> <select>".mkminute('')."</select>
 <select ><option value='AM'>AM</option><option value='PM'>PM</option></select> Effort to Rouse Defendant: <input size='50'></td></tr>";
	}
	if ($d[address1d]){
		$data .= "<tr><td><b>Attempt 1 at $d[address1d]</b> Month/Day/Year: <select>".mkmonth('')."</select> <select>".mkday('')."</select> <select>".mkyear('')."</select> Hour/Minute/AM-PM: <select>".mkmonth('')."</select> <select>".mkminute('')."</select>
 <select ><option value='AM'>AM</option><option value='PM'>PM</option></select> Effort to Rouse Defendant: <input size='50'></td></tr>";
		$data .= "<tr><td><b>Attempt 2 at $d[address1d]</b> Month/Day/Year: <select>".mkmonth('')."</select> <select>".mkday('')."</select> <select>".mkyear('')."</select> Hour/Minute/AM-PM: <select>".mkmonth('')."</select> <select>".mkminute('')."</select>
 <select ><option value='AM'>AM</option><option value='PM'>PM</option></select> Effort to Rouse Defendant: <input size='50'></td></tr>";
	}
	if ($d[address1e]){
		$data .= "<tr><td><b>Attempt 1 at $d[address1e]</b> Month/Day/Year: <select>".mkmonth('')."</select> <select>".mkday('')."</select> <select>".mkyear('')."</select> Hour/Minute/AM-PM: <select>".mkmonth('')."</select> <select>".mkminute('')."</select>
 <select ><option value='AM'>AM</option><option value='PM'>PM</option></select> Effort to Rouse Defendant: <input size='50'></td></tr>";
		$data .= "<tr><td><b>Attempt 2 at $d[address1e]</b> Month/Day/Year: <select>".mkmonth('')."</select> <select>".mkday('')."</select> <select>".mkyear('')."</select> Hour/Minute/AM-PM: <select>".mkmonth('')."</select> <select>".mkminute('')."</select>
 <select ><option value='AM'>AM</option><option value='PM'>PM</option></select> Effort to Rouse Defendant: <input size='50'></td></tr>";
	}
	$data .= "<tr><td><div style='border: solid 1px;'><b>Personal Delivery to $name</b><br>Address: <select>$addressSelect</select> <br>Month/Day/Year: <select>".mkmonth('')."</select> <select>".mkday('')."</select> <select>".mkyear('')."</select> Hour/Minute/AM-PM: <select>".mkmonth('')."</select> <select>".mkminute('')."</select>
 <select ><option value='AM'>AM</option><option value='PM'>PM</option></select><br>Sex: <input size='3'> Race: <input> Age: <input size='3'> Height: <input size='3'> Weight: <input size='3'> Hair: <input> Glasses/Facial Hair/Other: <input></div></td></tr>";
	$data .= "<tr><td><div style='border: solid 1px;'><b>Substitute Service</b><br>Address: <select>$addressSelect</select> Name: <input> <br>Month/Day/Year: <select>".mkmonth('')."</select> <select>".mkday('')."</select> <select>".mkyear('')."</select> Hour/Minute/AM-PM: <select>".mkmonth('')."</select> <select>".mkminute('')."</select>
 ...
 Sex: <input size='3'> Race: <input> Age: <input size='3'> Height: <input size='3'> Weight: <input size='3'> Hair: <input size='3'> Glasses/Facial Hair/Other: <input></div></td></tr>";
	$data .= "<tr><td><div style='border: solid 1px;'><b>Posting at $d[address1]</b><br>Month/Day/Year: <select>".mkmonth('')."</select> <select>".mkday('')."</select> <select>".mkyear('')."</select> Hour/Minute/AM-PM: <select>".mkmonth('')."</select> <select>".mkminute('')."</select>
 <select ><option value='AM'>AM</option><option value='PM'>PM</option></select> Detail the Place of Posting: <input size='50'></div></td></tr>";
 $data .= "</table></fieldset>";
	return $data;
}?>
<style>
