...
<?	}else{
	...
	<?=id2name($data[server_id])?> is to post <?=$add1?>.</li>
<? }
	}
 ?>
		</td>
...
<tr><td>
<table style="border:solid 1px; font-size: 12px;" border=1 width="600px" align="center">
	<tr>
    	<td colspan="5" align="center"><b>Service Type 'D':</b></td>
    </tr>
    <tr>
    	<td colspan="5" align="center"><div style="width:400px; text-align:justify;"><div style="border:ridge 3px; font-size: 16px; width: 400px; align:justify;"><strong style="text-decoration:underline;">ALL SERVICE MUST TAKE INTO ACCOUNT:</strong><br>'Two good faith attempts on separate days' - MD Rule 14-209(b)</div>
		...
		<li>If the address is a business, appears vacant, or the defendants are not known at the address, do not make a second attempt, but instead notify the office as soon as possible, and we will determine how to proceed.</li></div></td>
    </tr>
    <tr>
    	<td><small># of Addresses</small></td>
      	<td colspan="4" align="center"><small>Activity</small></td>
    </tr>
	<tr>
    	<td>1</td>
      	<td colspan='4'>All attempts (and <b>posting</b>) at Deed of Trust address</td>
    </tr>
	<tr>
    	<td>2</td>
	...
	<tr>
        ...
        <td><b>posting</b> at Deed of Trust address</td>
        <td></td>
    </tr>
	<tr>
    	<td>4+</td>
